          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {displayTemplates.map((template) => (
              <Link
                ...
                className="group bg-white border border-slate-100 rounded-[2rem] overflow-hidden hover:border-slate-900/10 transition-all duration-500 shadow-[0_8px_30px_rgb(0,0,0,0.02)] hover:shadow-[0_24px_48px_-12px_rgba(0,0,0,0.08)] flex flex-col h-full"
              >
                {/* Top: Placeholder/Thumbnail Area */}
