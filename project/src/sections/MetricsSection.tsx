import { motion } from 'framer-motion';
 ...
 const stats = [
   { label: 'Flows Active', value: '14.2M+', description: 'Intelligent workflows running daily', color: 'text-emerald-400' },
   { label: 'Tasks Automated', value: '850M+', description: 'Manual operations replaced by logic', color: 'text-blue-400' },
   { label: 'Success Rate', value: '99.98%', description: 'Reliability for mission-critical ops', color: 'text-purple-400' },
   { label: 'Time Saved', value: '450k', description: 'Hours reclaimed by human teams', color: 'text-teal-400' },
 ];
