...
import { HeadphonesIcon, DatabaseZap, FileSearch, XCircle, CheckCircle2 } from 'lucide-react';
                ...
                <div className="flex flex-wrap justify-center gap-3 mb-16 lg:mb-20">
                    {USE_CASES.map((useCase) => (
                        <button
                            ...
                            className={`flex items-center gap-3 px-8 py-3 rounded-full text-sm font-bold transition-all duration-300 border ${activeTab === useCase.id
