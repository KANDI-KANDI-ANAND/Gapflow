  ...
  return (
    <section className="py-12 bg-white overflow-hidden">
      <div className="container-standard">
        <div className="bg-[#f8fafc] border border-slate-100 rounded-[3rem] py-10 lg:py-12 px-8 lg:px-16 relative shadow-sm">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-center">

            <div className="bg-white rounded-[2rem] p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-50">
              <span className="text-[10px] font-black tracking-[0.2em] text-[#10B981] uppercase mb-4 block">
                PRODUCT LAYER
              </span>
